-- Combined last-mile migration bundle for the doctor board and feature summary.
...
alter table public.report_requests
  ...
  add column if not exists requested_at timestamptz default timezone('utc', now()),
